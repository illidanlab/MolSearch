...
parser.add_argument('--mol_idx', type = int, default = 1)
...
model_str = args.goal + '_maxchild_' + str(args.max_child) + '_sim_' + str(args.num_sims) + '_scalar_' + str(args.scalar) +  '_idx_' + str(args.mol_idx) + '_seed_' + str(args.seed)
...
smiles = start_mol_list[args.mol_idx]
